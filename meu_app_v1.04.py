...
#  Ultima atualização 28/04/2024 as 15:1500 hs
#  #########################################
...
def aviso_script():
    # st.markdown('aviso.html')
    return st.warning('Programa Ok')
...
with st.sidebar:
    ...
    # st.button('Java Script', on_click=aviso_script)
...
with st.container(border=True, height=200):  # Rodapé da Pagina
    ...
    st.write("Copyright(C) 2024 - Direitos Reservados - Versão 1.04 - 28/04/2024")
